...
class TestActionStandalone:
    ...
    def test_standalone_with_prefix(self):
        ...
        assert result == "@post('/post/auth.register_user')"
    ...
    def test_standalone_no_prefix(self):
        ...
        assert result == "@get('/get/health_check')"
    ...
    def test_get_with_query_params(self):
        ...
        assert "@get('/get/admin.dashboard?" in result
    ...
    def test_post_with_literal_params(self):
        ...
        assert "@post('/post/auth.register')" in result
...
class TestActionEntityClass:
    ...
    def test_class_method_with_id(self):
        ...
        assert result == "@post('/post/Todo:abc123.toggle')"
    ...
    def test_class_method_with_signal_id(self):
        ...
        assert result == "@post('/post/Todo:$selected_id.toggle')"
    ...
    def test_class_method_no_self_no_id(self):
        ...
        assert result == "@get('/get/Todo.load_all')"
    ...
    def test_delete_method(self):
        ...
        assert result == "@delete('/delete/Todo:xyz.remove')"
...
class TestActionBoundInstance:
    ...
    def test_bound_method_auto_injects_id(self):
        ...
        assert result == "@post('/post/FakeEntity:auto-id-123.save_data')"
    ...
    def test_bound_method_with_params(self):
        ...
        assert "@post('/post/FakeEntity:e1.update')" in result
