...
def example_arithmetic():
    ...
    return Div(
        Div(
            Div(
                # Label("X: "),
                Input(label="X:", type="number", bind=numbers.x, style="width: 80px; padding: 0.25rem;"),
                style="display: flex; gap: 0.5rem; align-items: center;"
            ),
            Div(
                # Label("Y: "),
                Input(label="Y:", type= "number", bind=numbers.y, style="width: 80px; padding: 0.25rem;"),
                style="display: flex; gap: 0.5rem; align-items: center;"
            ),
...
def example_conditional():
    ...
    return Div(
        Div(
            # Label("Score: "),
            Input(label="Score:", type="number", bind=score, style="width: 100px; padding: 0.25rem;"),
...
def example_string_methods():
    ...
    return Div(
        Div(
            Input(label="Text:", type="text", bind=text, placeholder="Enter text", style="width: 100%; padding: 0.5rem;"),
...
def example_array_methods():
    ...
    return Div(
        Div(
            Input(label="New item:", type="text", bind=new_item, placeholder="New item", style="padding: 0.5rem; margin-right: 0.5rem;"),
...
def example_math_methods():
    ...
    return Div(
        Div(
            # Label("Value: "),
            Input(label="Value:", type="number", bind=value, step="0.1", style="width: 120px; padding: 0.25rem;"),
            style="display: flex; gap: 0.5rem; align-items: center; margin-bottom: 1rem;"
        ),
        Div(
            P(text="Value: " + value),
...
def example_template_literals():
    ...
    return Div(
        Div(
            Div(
                # Label("First Name: "),
                Input(label="First Name:", type="text", bind=usr.first_name, style="padding: 0.25rem;"),
                style="display: flex; gap: 0.5rem; align-items: center;"
            ),
            Div(
                # Label("Last Name: "),
                Input(label="Last Name:", type="text", bind=usr.last_name, style="padding: 0.25rem;"),
                style="display: flex; gap: 0.5rem; align-items: center;"
            ),
            Div(
                # Label("Age: "),
                Input(label="Age:", type="number", bind=usr.age_val, style="width: 80px; padding: 0.25rem;"),
                style="display: flex; gap: 0.5rem; align-items: center;"
            ),
...
def example_collect_classes():
    ...
    return Div(
        Div(
            Label(Input(label="Large:", type="checkbox", bind=is_large), " Large", style="margin-right: 1rem;"),
            Label(Input(label="Bold:", type="checkbox", bind=is_bold), " Bold", style="margin-right: 1rem;"),
            Label(Input(label="Italic:", type="checkbox", bind=is_italic), " Italic"),
            style="margin-bottom: 1rem;"
        ),
        Div(
            P(
...
def example_dynamic_classes():
    ...
    return Div(
        Div(
            Label(Input(label="Large:", type="checkbox", bind=styles.cls_large), " Large", style="margin-right: 1rem;"),
            Label(Input(label="Bold:", type="checkbox", bind=styles.cls_bold), " Bold", style="margin-right: 1rem;"),
            Label(Input(label="Italic:", type="checkbox", bind=styles.cls_italic), " Italic", style="margin-right: 1rem;"),
            Label(Input(label="Blue:", type="checkbox", bind=styles.cls_blue), " Blue"),
            style="margin-bottom: 1rem;"
        ),
        Div(
            P(
    ...
    return Div(
        Div(
            Div(
                ...
                Input(label="Name:", type="text", bind=form_name, placeholder="Min 3 chars", style="width: 100%; padding: 0.5rem; margin-bottom: 0.25rem;"),
            ...
            Div(
                ...
                Input(label="Email:", type="email", bind=form_email, placeholder="your@email.com", style="width: 100%; padding: 0.5rem; margin-bottom: 0.25rem;"),
            ...
            Div(
                ...
                Input(label="Age:", type="number", bind=form_age, placeholder="18+", style="width: 100%; padding: 0.5rem; margin-bottom: 0.25rem;"),
                P("✓ Valid", data_show=age_valid, style="color: green; margin: 0;"),
                P("✗ Must be 18+", data_show=~age_valid, style="color: red; margin: 0;"),
                style="margin-bottom: 1rem;"
            ),
            Div(
                Label(Input(label="Agree to terms:", type="checkbox", bind=form_agree), " I agree to terms"),
                style="margin-bottom: 1rem;"
            ),
        ),
        Div(
...
@template(title="RustyTags Datastar SDK")
def rustytags_docs():
    return Div(
