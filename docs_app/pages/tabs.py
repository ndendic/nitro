...
def example_1():
    return Tabs(
        ...
        TabsContent(
            P(
                "This is the content of the first tab. Click the other tabs to see the content change!"
            ),
            id="tab1",
            cls="p-3",
        ),
        TabsContent(
            P(
                "This is the content of the second tab. Notice how the keyboard navigation works with arrow keys."
            ),
            id="tab2",
            cls="p-3",
        ),
        TabsContent(
            P(
                "This is the content of the third tab. The component handles all ARIA attributes automatically."
            ),
            id="tab3",
            cls="p-3",
        ),
