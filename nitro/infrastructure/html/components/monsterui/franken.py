...
def CodeSpan(
    ...
    **kwargs,  # Additional args for CodeSpan tag
    ...
    return fh.Code(*c, cls=cn("uk-codespan", cn(cls)), **kwargs)


# %% ../nbs/02_franken.ipynb
def CodeBlock(
    *c: str,  # Contents of Code tag (often text)
    ...
    **kwargs,  # Additional args for Code tag
    ...
    return Div(
        Pre(
            Code(*c, cls=cn("uk-codeblock", cn(code_cls)), **kwargs),
            cls=cn(
                f"bg-gray-100 dark:bg-gray-800 {TextT.gray} p-0.4 rounded text-sm font-mono"
            ),
        ),
        #             cls=cn('bg-gray-100 dark:bg-gray-800 dark:text-gray-200 p-0.4 rounded text-sm font-mono')),
        cls=cn("uk-block", cn(cls)),
    )


# %% ../nbs/02_franken.ipynb
def H1(
    *c: HtmlString | str,  # Contents of H1 tag (often text)
    ...
    **kwargs,  # Additional args for H1 tag
    ...
    return fh.H1(*c, cls=cn("uk-h1", cn(cls)), **kwargs)


# %% ../nbs/02_franken.ipynb
def H2(
    *c: HtmlString | str,  # Contents of H2 tag (often text)
    ...
    **kwargs,  # Additional args for H2 tag
    ...
    return fh.H2(*c, cls=cn("uk-h2", cn(cls)), **kwargs)
...
def H3(
    ...
    **kwargs,  # Additional args for H3 tag
    ...
    return fh.H3(*c, cls=cn("uk-h3", cn(cls)), **kwargs)
...
def H4(
    ...
    **kwargs,  # Additional args for H4 tag
    ...
    return fh.H4(*c, cls=cn("uk-h4", cn(cls)), **kwargs)
...
def H5(
    ...
    **kwargs,  # Additional args for H5 tag
    ...
    return fh.H5(*c, cls=cn("text-lg font-semibold", cn(cls)), **kwargs)
...
def H6(
    ...
    **kwargs,  # Additional args for H6 tag
    ...
    return fh.H6(*c, cls=cn("text-base font-semibold", cn(cls)), **kwargs)
...
def Subtitle(
    ...
    **kwargs,  # Additional args for P tag
    ...
    return fh.P(*c, cls=cn(TextPresets.muted_sm, cn(cls)), **kwargs)
...
def Q(
    ...
    **kwargs,  # Additional args for Q tag
    ...
    return fh.Q(*c, cls=cn(TextT.italic, TextT.lg, cn(cls)), **kwargs)
...
def Em(
    ...
    **kwargs,  # Additional args for Em tag
    ...
    return fh.Em(*c, cls=cn(TextT.medium, cn(cls)), **kwargs)
...
def Strong(
    ...
    **kwargs,  # Additional args for Strong tag
    ...
    "Styled strong text"
    return fh.Strong(*c, cls=cn(TextT.bold, cn(cls)), **kwargs)
...
def I(
    ...
    **kwargs,  # Additional args for I tag
    ...
    "Styled italic text"
    return fh.I(*c, cls=cn(TextT.italic, cn(cls)), **kwargs)
...
def Small(
    ...
    **kwargs,  # Additional args for Small tag
    ...
    "Styled small text"
    return fh.Small(*c, cls=cn(TextT.sm, cn(cls)), **kwargs)
...
def Mark(
    ...
    **kwargs,  # Additional args for Mark tag
    ...
    return fh.Mark(*c, cls=cn(TextT.highlight, cn(cls)), **kwargs)
...
def Del(
    ...
    **kwargs,  # Additional args for Del tag
    ...
    "Styled deleted text"
    return fh.Del(*c, cls=cn("line-through", TextT.gray, cn(cls)), **kwargs)


def Ins(
    *c: HtmlString | str,  # Contents of Ins tag (inserted text)
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Ins tag
) -> HtmlString:
    "Styled inserted text"
    return fh.Ins(*c, cls=cn(TextT.underline + " text-green-600", cn(cls)), **kwargs)
...
def Sub(
    ...
    **kwargs,  # Additional args for Sub tag
    ...
    return fh.Sub(*c, cls=cn(TextT.sm + " -bottom-1 relative", cn(cls)), **kwargs)
...
def Sup(
    ...
    **kwargs,  # Additional args for Sup tag
    ...
    return fh.Sup(*c, cls=cn(TextT.sm + " -top-1 relative", cn(cls)), **kwargs)


# %% ../nbs/02_franken.ipynb
def Blockquote(
    *c: HtmlString | str,  # Contents of Blockquote tag (often text)
    ...
    **kwargs,  # Additional args for Blockquote tag
    ...
    return fh.Blockquote(*c, cls=cn("uk-blockquote", cn(cls)), **kwargs)


# %% ../nbs/02_franken.ipynb
def Caption(*c: HtmlString | str, cls: Enum | str | tuple = (), **kwargs) -> HtmlString:
    "Styled caption text"
    return fh.Caption(Span(*c, cls=cn(TextT.gray, TextT.sm, cn(cls))), **kwargs)


# %% ../nbs/02_franken.ipynb
def Cite(
    *c: HtmlString | str,  # Contents of Cite tag
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Cite tag
) -> HtmlString:
    "Styled citation text"
    return fh.Cite(*c, cls=cn(TextT.italic, TextT.gray, cn(cls)), **kwargs)


def Time(
    *c: HtmlString | str,  # Contents of Time tag
    cls: Enum | str | tuple = (),  # Additional classes
    ...
    **kwargs,  # Additional args for Time tag
    ...
    return fh.Time(*c, cls=cn(TextT.gray, cn(cls)), **kwargs)


def Address(
    *c: HtmlString | str,  # Contents of Address tag
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Address tag
) -> HtmlString:
    "Styled address element"
    return fh.Address(*c, cls=cn(TextT.italic, cn(cls)), **kwargs)


# %% ../nbs/02_franken.ipynb
def Abbr(
    *c: HtmlString | str,  # Contents of Abbr tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Dfn(
    *c: HtmlString | str,  # Contents of Dfn tag (definition)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Kbd(
    *c: HtmlString | str,  # Contents of Kbd tag (keyboard input)
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Samp(
    *c: HtmlString | str,  # Contents of Samp tag (sample output)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Var(
    *c: HtmlString | str,  # Contents of Var tag (variable)
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Figure(
    *c: HtmlString | str,  # Contents of Figure tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Meter(
    ...
    **kwargs,  # Additional args for Meter tag
    ...
    if max is not None:
        kwargs["max"] = max
    return fh.Meter(*c, cls=cn("w-full h-2 bg-secondary rounded", cn(cls)), **kwargs)
...
def S(
    ...
    **kwargs,  # Additional args for S tag
    ...
    return fh.S(*c, cls=cn("line-through", TextT.gray, cn(cls)), **kwargs)
...
def U(
    ...
    **kwargs,  # Additional args for U tag
    ...
    return fh.U(*c, cls=cn(TextT.underline, cn(cls)), **kwargs)
...
# %% ../nbs/02_franken.ipynb
def AccordionItem(
    title: Union[str, HtmlString],  # Content for the accordion item title
    *c: HtmlString,  # Content to display when the item is open
    cls: Union[
        str, Enum, tuple
    ] = (),  # Additional classes for the outer `Li` container
    title_cls: Union[str, Enum, tuple] = (
        "flex justify-between items-center w-full",
    ),  # Additional classes for the title `A` tag
    content_cls: Union[
        str, Enum, tuple
    ] = (),  # Additional classes for the content `Div`
    ...
    div_kwargs: Optional[
        Dict
    ] = None,  # Additional attributes for the content `Div` tag
    ...
    li_classes = ["group", cn(cls)]
    if open:
        li_classes.append("uk-open")
    final_li_cls = cn(li_classes)
    combined_title_cls = cn(("uk-accordion-title", cn(title_cls)))
    content_classes = cn(("uk-accordion-content", cn(content_cls)))
    if "href" not in a_attrs:
        a_attrs["href"] = "#"
    icon_container = Span(
...
# %% ../nbs/02_franken.ipynb
def Accordion(
    *c: "AccordionItem",  # One or more `AccordionItem` components
    cls: Union[
        str, Enum, tuple
    ] = (),  # Additional classes for the container (`Ul` or `Div`)
    multiple: Optional[
        bool
    ] = None,  # Allow multiple items to be open simultaneously (UIkit option)
    collapsible: Optional[
        bool
    ] = None,  # Allow all items to be closed (UIkit option, default True)
    animation: Optional[
        bool
    ] = None,  # Enable/disable animation (UIkit option, default True)
    duration: Optional[
        int
    ] = None,  # Animation duration in ms (UIkit option, default 200)
    active: Optional[
        int
    ] = None,  # Index (0-based) of the item to be open by default (UIkit option)
    transition: Optional[
        str
    ] = None,  # Animation transition timing function (UIkit option, e.g., 'ease-out')
    ...
    **kwargs,  # Additional attributes for the container tag (e.g., id)
    ...
    if multiple is not None:
        opts.append(f"multiple: {str(multiple).lower()}")
    if collapsible is not None:
        opts.append(f"collapsible: {str(collapsible).lower()}")
    if animation is not None:
        opts.append(f"animation: {str(animation).lower()}")
    if duration is not None:
        opts.append(f"duration: {duration}")
    if active is not None:
        opts.append(f"active: {active}")
...
# %% ../nbs/02_franken.ipynb
def Button(
    *c: Union[str, HtmlString],  # Contents of `Button` tag (often text)
    cls: Union[
        str, Enum
    ] = ButtonT.default,  # Classes in addition to `Button` styling (use `ButtonT` for built in styles)
    ...
    **kwargs,  # Additional args for `Button` tag
    ...
    return fh.Button(*c, cls=cn("uk-btn", cn(cls)), **kwargs)
